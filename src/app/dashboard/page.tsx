    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (userDoc.exists()) {
                ...
                const nextStats = normalizeUserStats(rawStats);
                ...
                if (userStatsNeedBackfill(rawStats)) {
                    pendingUpdates.stats = mergeUserStats(rawStats);
                }
                ...
                if (currentPerformance) {
                    ...
                    if (hasAdaptiveDelta) {
                        pendingUpdates.performanceHistory = adaptivePerformance;
                    }
                } else {
                ...
                if (Object.keys(pendingUpdates).length > 0) {
                    await updateDoc(doc(db, "users", user.uid), pendingUpdates);
                }
            }
        } catch (e: unknown) {
            console.error(e);
                            ...
                            <div className="rounded-xl border-2 border-black bg-white p-4">
                                <div className="flex flex-wrap items-center justify-between gap-3">
                                    ...
                                    <button
                                        ...
                                        className={`rounded-lg border-2 border-black px-4 py-2 text-sm font-black uppercase tracking-wide shadow-[2px_2px_0px_0px_#000] transition-all ${insightsCollapsed
