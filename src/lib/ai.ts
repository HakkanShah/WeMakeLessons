...
export async function getAITutorResponse(
    ...
    const baseSystemPrompt = isQuizRelated
       ...
       Great choice! I'm taking you to the course generator to start a journey into Medieval History. (If you aren't redirected automatically, open 'History' in the sidebar and use 'Forge New Quest'.)"
