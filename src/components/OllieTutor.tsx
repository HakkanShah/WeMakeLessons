...
export default function OllieTutor() {
    const { user, learningProfile } = useAuth();
    ...
    const { cancel, setOllieVoiceEnabled, speakOllie } = useVoice();
        ...
        try {
            ...
            if (data.response) {
                ...
                if (cleanResponse.match(redirectRegex)) {
                    ...
                    confirmationMsg += "\n\n(If you aren't redirected automatically, open 'History' in the sidebar and use 'Forge New Quest'.)";
                ...
                >
                    ...
                    {mode === "voice" && (
                        <div className="ollie-voice-body relative" style={{ height: "26rem" }}>
                            <OllieVoiceMode onSwitchToText={handleSwitchToText} />
                        </div>
                    )}
